// Suggested themes and sample origins from Fabula Ultima Livro Básico
...
// Example identities from the book to inspire players
export const FU_EXAMPLE_IDENTITIES = [
  ...
  'Cientista tecномágico',
  'Veterana atormentada',
  'Samurai de um olho só',
];

// Attribute distribution profiles from the book
...
// Preset characters from the book as inspiration references
